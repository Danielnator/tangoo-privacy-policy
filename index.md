...
Welcome to Tangoo ("we," "us," or "our"). Tangoo is a Japanese dictionary mobile application designed to help users learn Japanese through an offline-first dictionary, word lists, customizable tests, and more.
